    ...
    <section id="about" className="py-14 md:py-20">
      <div className="section-shell grid items-center gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <div>
          ...
          <p className="text-base font-semibold leading-7 text-gray-700 md:text-lg md:leading-8">
          ...
          <div className="mt-6 grid grid-cols-1 gap-3 md:grid-cols-3">
            {["Quick bites", "Party orders", "Home delivery"].map((value) => (
              <div key={value} className="rounded-2xl bg-white p-5 text-center shadow-lg shadow-orange-900/10">
